        ...
        <AutoColumn gap="12px" justify={'center'}>
          ...
          {currencyToAdd && library?.provider?.isMetaMask && (
              <ButtonLight mt="12px" padding="6px 12px" width="fit-content">
                {!success ? (
                    <RowFixed onClick={addToken}>
                      Add {changeSymbol(chainId, currencyToAdd.symbol)} to Metamask <StyledLogo src={MetaMaskLogo} />
                    </RowFixed>
                ) : (
                    <RowFixed>
                      Added {changeSymbol(chainId, currencyToAdd.symbol)}{' '}
